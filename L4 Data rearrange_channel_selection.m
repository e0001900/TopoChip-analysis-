...
Int_nuc_11 = reshape(Int_nuc11,[3300,3300]);
Int_alb_11 = reshape(Int_alb11,[3300,3300]);
Int_ck_11=reshape(Int_ck11,[3300,3300]);
Int_cyp_11=reshape(Int_cyp11,[3300,3300]);
% find the reshaped matrix for ratio
alb_Int_nuc_Int_11 = reshape(alb_Int_nuc_Int11,[3300,3300]);
ck_Int_nuc_Int_11 = reshape(ck_Int_nuc_Int11,[3300,3300]);
cyp_Int_nuc_Int_11 = reshape(cyp_Int_nuc_Int11,[3300,3300]);
...
% reshape: vector to matrix
Int_nuc_12 = reshape(Int_nuc12,[3300,3300]);
Int_alb_12 = reshape(Int_alb12,[3300,3300]);
Int_ck_12=reshape(Int_ck12,[3300,3300]);
Int_cyp_12=reshape(Int_cyp12,[3300,3300]);
alb_Int_nuc_Int_12 = reshape(alb_Int_nuc_Int12,[3300,3300]);
ck_Int_nuc_Int_12 = reshape(ck_Int_nuc_Int12,[3300,3300]);
cyp_Int_nuc_Int_12 = reshape(cyp_Int_nuc_Int12,[3300,3300]);
mean_alb12=(alb_Int_nuc_Int_12(1700,1700)+alb_Int_nuc_Int_12(3300,1))/2;
mean_ck12=(ck_Int_nuc_Int_12(1700,1700)+ck_Int_nuc_Int_12(3300,1))/2;
mean_cyp12=(cyp_Int_nuc_Int_12(1700,1700)+cyp_Int_nuc_Int_12(3300,1))/2;
...
% reshape: vector to matrix
Int_nuc_21 = reshape(Int_nuc21,[3300,3300]);
Int_alb_21 = reshape(Int_alb21,[3300,3300]);
Int_ck_21=reshape(Int_ck21,[3300,3300]);
Int_cyp_21=reshape(Int_cyp21,[3300,3300]);
alb_Int_nuc_Int_21 = reshape(alb_Int_nuc_Int21,[3300,3300]);
ck_Int_nuc_Int_21 = reshape(ck_Int_nuc_Int21,[3300,3300]);
cyp_Int_nuc_Int_21 = reshape(cyp_Int_nuc_Int21,[3300,3300]);
mean_alb21=(alb_Int_nuc_Int_21(1700,1700)+alb_Int_nuc_Int_21(3300,1))/2;
mean_ck21=(ck_Int_nuc_Int_21(1700,1700)+ck_Int_nuc_Int_21(3300,1))/2;
mean_cyp21=(cyp_Int_nuc_Int_21(1700,1700)+cyp_Int_nuc_Int_21(3300,1))/2;
...
% reshape: vector to matrix
Int_nuc_22 = reshape(Int_nuc22,[3300,3300]);
Int_alb_22 = reshape(Int_alb22,[3300,3300]);
Int_ck_22=reshape(Int_ck22,[3300,3300]);
Int_cyp_22=reshape(Int_cyp22,[3300,3300]);
alb_Int_nuc_Int_22 = reshape(alb_Int_nuc_Int22,[3300,3300]);
ck_Int_nuc_Int_22 = reshape(ck_Int_nuc_Int22,[3300,3300]);
cyp_Int_nuc_Int_22 = reshape(cyp_Int_nuc_Int22,[3300,3300]);
% mean_alb22=1;
% mean_cyp22=1;
% mean_unk22=1;
...
alb_Int_nuc_Int_mean_top1=zeros(3300,3300);
ck_Int_nuc_Int_mean_top1=zeros(3300,3300);
cyp_Int_nuc_Int_mean_top1=zeros(3300,3300);

alb_Int_nuc_Int_mean_top2=zeros(3300,3300);
ck_Int_nuc_Int_mean_top2=zeros(3300,3300);
cyp_Int_nuc_Int_mean_top2=zeros(3300,3300);
...
% make threshold
thres1=0.0000000001;
alb_Int_nuc_Int_mean_top11=zeros(3300,3300);
ck_Int_nuc_Int_mean_top11=zeros(3300,3300);
cyp_Int_nuc_Int_mean_top11=zeros(3300,3300);
alb_Int_nuc_Int_mean_top22=zeros(3300,3300);
ck_Int_nuc_Int_mean_top22=zeros(3300,3300);
cyp_Int_nuc_Int_mean_top22=zeros(3300,3300);
...
Final=[1:10890000; Int_nuc11;Int_alb11;Int_ck11;Int_cyp11;alb_Int_nuc_Int11;ck_Int_nuc_Int11;cyp_Int_nuc_Int11];
xlswrite ('Upper left result.xlsx',d);
xlswrite ('Upper left result.xlsx',Final,1,'B1');

d={'Number';'Nuclei Intensity';'Albumin Intensity';'CK Intensity';'CYP Intensity';'Albumin intensity Normalised to Nucleus Intensity ';'CK intensity Normalised to Nucleus Intensity';'CYP intensity Normalised to Nucleus Intensity'};
Final=[1:10890000; Int_nuc12;Int_alb12;Int_ck12;Int_cyp12;alb_Int_nuc_Int12;ck_Int_nuc_Int12;cyp_Int_nuc_Int12];
xlswrite ('Upper right result.xlsx',d);
xlswrite ('Upper right result.xlsx',Final,1,'B1');

d={'Number';'Nuclei Intensity';'Albumin Intensity';'CK Intensity';'CYP Intensity';'Albumin intensity Normalised to Nucleus Intensity ';'CK intensity Normalised to Nucleus Intensity';'CYP intensity Normalised to Nucleus Intensity'};
Final=[1:10890000; Int_nuc21;Int_alb21;Int_ck21;Int_cyp21;alb_Int_nuc_Int21;ck_Int_nuc_Int21;cyp_Int_nuc_Int21];
xlswrite ('Lower left result.xlsx',d);
xlswrite ('Lower left result.xlsx',Final,1,'B1');

d={'Number';'Nuclei Intensity';'Albumin Intensity';'CK Intensity';'CYP Intensity';'Albumin intensity Normalised to Nucleus Intensity ';'CK intensity Normalised to Nucleus Intensity';'CYP intensity Normalised to Nucleus Intensity'};
Final=[1:10890000; Int_nuc22;Int_alb22;Int_ck22;Int_cyp22;alb_Int_nuc_Int22;ck_Int_nuc_Int22;cyp_Int_nuc_Int22];
...
colorbar
figname=['cell detection for pile 1'];
print('-r300','-dtiff', fullfile(pwd,figname))
h11=figure();
colormap('redgreencmap')
imagesc(bil_cell_top2)
colorbar
figname=['cell detection for pile 2'];
print('-r300','-dtiff', fullfile(pwd,figname))
